...
typedef enum {
	...
	ONEPASS_FRACTIONAL_GREEDY,
        ONEPASS_LEIDEN,                  // Streaming Graph Clustering
        ONEPASS_MODULARITY              // Streaming Graph Clustering
...
//////////////////////////////////////////////////////
//////In-Memory external Clustering algorithms ///////
///////////////////// (Start) ////////////////////////
//////////////////////////////////////////////////////

typedef enum {
        EXT_VIECLUS_ALGORITHM,
        EXT_LEIDEN_ALGORITHM,  
        NO_EXT_ALGORITHM         
...
struct PairHash {
    ...
    std::size_t operator()(const std::pair<T1, T2>& pair) const {
        ...
        // Combine the hashes (example: XOR with a prime multiplier)
